package com.kzdr.chatapp2.Adapter;
...
import com.kzdr.chatapp2.MessageActivity;
import com.kzdr.chatapp2.Model.Chat;
import com.kzdr.chatapp2.Model.User;
import com.kzdr.chatapp2.R;
...
public class UserAdapter extends RecyclerView.Adapter {
    ...
    //public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> 이렇게 않해서
    //RecyclerView.ViewHolder holder 됨 원랜 ViewHolder holder 되야됨
    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if(user.getImageURL().equals("default")){
            ...
            Glide.with(mContext).load(user.getImageURL()).into(((ViewHolder) myHolder).profile_image);
        }
